...
# Lambda and function dependencies
...
import random   # Used to generate ranom response IDs for dB
...
def lambda_handler(event, context):
    ...
    critical_phrases = ['article', 'articles', 'medium', 'Medium']
    email_text = email_response(dec_dict['name'], critical_phrases, phrase, sentiment)
    ...
    # -----------------------------
    SENDER = 'senderpredict@gmail.com'
    # -----------------------------
    
    # This address must be verified.
    # -----------------------------
    RECIPIENT = 'recipientpredict@gmail.com' 
    # -----------------------------
